 ...
 * 
 */
public class SlideMenuBehind extends ViewGroup {

    private static final String TAG = "SlideMenuBehind";

    private static final int MARGIN_THRESHOLD = 48; // dips

    private int mTouchMode = SlideMenu.TOUCHMODE_MARGIN;

    private SlideMenuAbove mViewAbove;
    ...
    public SlideMenuBehind(Context context) {
        this(context, null);
    }

    public SlideMenuBehind(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setCustomViewAbove(SlideMenuAbove customViewAbove) {
    ...
    public void setMode(int mode) {
        if (mode == SlideMenu.LEFT || mode == SlideMenu.RIGHT) {
            if (mContent != null)
    ...
    public int getMenuPage(int page) {
        ...
        if (mMode == SlideMenu.LEFT && page > 1) {
            return 0;
        } else if (mMode == SlideMenu.RIGHT && page < 1) {
            return 2;
        } else {
            return page;
        }
    ...
    public void scrollBehindTo(View content, int x, int y) {
        ...
        if (mMode == SlideMenu.LEFT) {
            ...
            if (x <= content.getLeft()) {
                ...
                scrollTo((int) (getBehindWidth() - getWidth() + (x - getBehindWidth())
                        * mScrollScale), y);
            }
        }
        setVisibility(vis);
    ...
    public int getAbsLeftBound(View content) {
        if (mMode == SlideMenu.LEFT || mMode == SlideMenu.LEFT_RIGHT) {
            return content.getLeft() - getBehindWidth();
        } else if (mMode == SlideMenu.RIGHT) {
            return content.getLeft();
        }
    ...
    public int getAbsRightBound(View content) {
        if (mMode == SlideMenu.LEFT) {
            return content.getLeft();
        } else if (mMode == SlideMenu.RIGHT || mMode == SlideMenu.LEFT_RIGHT) {
            return content.getLeft() + getBehindWidth();
        }
        return 0;
    }
    ...
    public boolean menuTouchInQuickReturn(View content, int currPage, float x) {
        if (mMode == SlideMenu.LEFT || (mMode == SlideMenu.LEFT_RIGHT && currPage == 0)) {
            return x >= content.getLeft();
        } else if (mMode == SlideMenu.RIGHT || (mMode == SlideMenu.LEFT_RIGHT && currPage == 2)) {
